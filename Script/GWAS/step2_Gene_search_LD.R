...
GWASresult <- read.csv(paste("GWAS/MLM_QK_pc6/pheno_",phenoNo,"_",pheno,"_gwas_result.csv", sep=""), row.names = 1)
...
write.csv(resmat,paste("GWAS/AssoGenes_MLM_QK_pc6/GWAS_Top",nrow(matassoSNPs),"SNPs_pheno_",phenoNo,"_",pheno,"_",region/1000,"kb_candidateGenes.csv",sep=""),quote=F,row.names=F)
...
write.csv(resmatAno,paste("GWAS/AssoGenes_MLM_QK_pc6/GWAS_Top",nrow(matassoSNPs),"SNPs_pheno_",phenoNo,"_",pheno,"_",region/1000,"kb_candidateGenes_Anotation.csv",sep=""),quote=F,row.names=F)
