...
##setwd
setwd("/Users/HirotoYAMASHITA/BioInfo/R analysis/Genetics/TeaGWAS/ChrLev")
...
write.csv(pca_cum, "geno/geno pca/geno_pca_cum.csv")
...
#draw manhattan plot
png(paste("GWAS/MLM_QK_pc6/pheno_",i,"_",Trait,"_manhattan.png", sep=""),width=350, height=300)
manhattan(mht, 
...
#output gwas results
write.csv(mht,
          paste("GWAS/MLM_QK_pc6/pheno_",i,"_",Trait,"_gwas_result.csv", sep=""))

##draw Q-Q plot
setEPS()
postscript(file =paste("GWAS/MLM_QK_pc6/pheno_",i,"_",Trait,"_QQplot.eps",sep=""), width=4, height=4)
